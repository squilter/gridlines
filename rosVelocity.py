...
def getVelocity():
	...
	print 'airspeed: '+v.airspeed
	print 'groundspeed: '+v.groundspeed

	rate1=rospy.Rate(velocityFrequency)
...
def getIMU():
	msg = v.message_factory.scaled_imu_encode() 
...
def setOrigin(mylat,mylong,myalt):
	msg = v.message_factory.set_gps_global_origin_encode(mylat,mylong,myalt)
